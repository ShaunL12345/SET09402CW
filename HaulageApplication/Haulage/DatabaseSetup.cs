...
public static class DatabaseSetup
{
    ...
    public static void CreateTables(SQLiteConnection connection)
    {
        ...
        List<string> createTableScripts = new List<string>
        {
            ...
            @"CREATE TABLE IF NOT EXISTS Event (EventId INTEGER PRIMARY KEY AUTOINCREMENT, DriverId INTEGER NOT NULL, TripId INTEGER NOT NULL, EventType INTEGER NOT NULL);"
        };
