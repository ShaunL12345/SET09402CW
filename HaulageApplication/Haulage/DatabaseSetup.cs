...
public static class DatabaseSetup
{
    ...
    private static void CreateData(SQLiteConnection connection)
    {
        List<string> dataScripts = new List<string>
        {
            ...
            @"INSERT INTO [Expense] ([ExpenseId], [DriverID], [VehicleId], [Fullname], [Expense], [ExpenseDescription], [ExpenseCost]) VALUES (1928, 682738, 9992283410, 'Richard Sparks', 'Food Allowance', 'Allowance provided by Comapny for breaks', '£20.00');",
            @"INSERT INTO [Expense] ([ExpenseId], [DriverID], [VehicleId], [Fullname], [Expense], [ExpenseDescription], [ExpenseCost]) VALUES (1828, 692840, 9928472842, 'Richard Sparks', 'BreakDown Accomodation', 'Allowance provided for breakbodw accomodation if AA are unavailable','£50.00');",
            @"INSERT INTO [Expense] ([ExpenseId], [DriverID], [VehicleId], [Fullname], [Expense], [ExpenseDescription], [ExpenseCost]) VALUES (1838, 699032, 9183924838, 'Richard Sparks', 'Food Allowance', 'Allowance provided by comapny for breaks', '£20.00');",
        };
